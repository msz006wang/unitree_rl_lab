"""
G1速度跟踪环境配置 - 平地地形
G1 Velocity Tracking Environment Configuration - Flat Terrain

这是velocity_env_cfg.py的简化版本，使用平地地形进行基础训练。
This is a simplified version of velocity_env_cfg.py using flat terrain for basic training.
...
@configclass
class RewardsCfg:
    """Reward terms for MDP (Original configuration)."""
...
class TerminationsCfg:
    ...
    base_height = DoneTerm(
        ...
        params={"minimum_height": 0.15}  # 原始值
    )

    bad_orientation = DoneTerm(
        func=mdp.bad_orientation,
        params={"limit_angle": 1.0}  # 原始值
    )
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for locomotion velocity-tracking environment on flat terrain."""
    ...
    def __post_init__(self):
        ...
        # general settings
        self.decimation = 4
        self.episode_length_s = 20.0  # 原始episode长度
